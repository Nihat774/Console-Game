            ...
            <div className="artboard artboard-demo phone-1   flex flex-col justify-start mt-10 w-full">
              ...
              <div className="flex justify-around w-full ">
                <div className="flex flex-col justify-center">
                  <img
                    ...
                    className=" rounded-full size-[10vh]"
                    alt=""
                  />
                </div>
                ...
                <div className="w-[70%]">
                  ...
                  <div className="flex gap-1">
                    <div className="border rounded-[6px] border-blue-500 w-[25vw]">
                      <p className="text-blue-500 text-[.8rem] font-semibold py-2 flex justify-center">
                        <i className="p-1 fa-solid fa-plus"></i>
                        <p>FOLLOW</p>
                      </p>
                    </div>

                    <div>
                      <i className="p-2 border text-blue-500 border-blue-500 rounded-[6px] fa-solid fa-caret-down"></i>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-2 w-full">
               ...
               <p className="font-bold flex gap-1">
                  <p>console.game</p>
                  <i className="text-blue-600 fa-solid fa-circle-check"></i>
                </p>
                <p className="text-wstone flex end">Game design point</p>
                <p className="text-stone flex end">Followed by webdeveloper</p>
                <p className="text-blue-600 flex end">www.consolegame.com</p>
               </div>
              </div>
              {/* ICONS */}
              ...
              <div className="grid grid-cols-3">
                <img
                  className="h-[14vh]"
                  src="/instaImage/nature1.jpeg"
                  alt=""
                />
                <img
                  className="h-[14vh]"
                  src="/instaImage/nature2.jpeg"
                  alt=""
                />
                <img
                  className="h-[14vh]"
                  src="/instaImage/nature3.jpeg"
                  alt=""
                />
                <img
                  className="h-[14vh]"
                  src="/instaImage/nature4.jpeg"
                  alt=""
                />
                <img
                  className="h-[14vh]"
                  src="/instaImage/nature5.jpeg"
                  alt=""
                />
                <img
                  className="h-[14vh]"
                  src="/instaImage/nature6.jpeg"
                  alt=""
                />
              </div>
              ...
              <div className="w-full flex justify-around py-3 text-[1rem] border-b-2 border-wstone ">
                ...
                <img
                  ...
                  src="public/instaImage/nature6.jpeg"
                  alt=""
                />
              </div>
