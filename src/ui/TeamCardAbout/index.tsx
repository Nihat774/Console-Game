...
function TeamCard({img,name,text}:ITeamType) {
    return (
        <>
            <Link to={'/news'} className="bg-qara lg:h-[35vh] lg:w-[20vw]  xs:h-[30vh] xs:w-[50vw] rounded-md p-5 flex flex-col justify-evenly  hover:shadow-orange/100 hover:shadow-md ">
